...
| [Public Data Endpoints](public-data-endpoints.md) | Structured JSON endpoints at /data/*.json and REP supply endpoints at /api/supply/* for external consumers — schemas, conventions, adding new endpoints |
